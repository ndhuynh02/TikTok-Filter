...
filters_config = {
    'kamen_rider':
        [{'path': "/home/hayade/project/Tiktok-Filter/app/filters/zero-one.png",
         'anno_path': "/home/hayade/project/Tiktok-Filter/app/filters/zero-one.csv",
...
def load_filter(filter_name="kamen_rider"):
...
if __name__ == "__main__":
    ...
    videoCapture = cv2.VideoCapture('/home/hayade/project/Tiktok-Filter/noGlasses.mp4')
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')

    width = int(videoCapture.get(cv2.CAP_PROP_FRAME_WIDTH))
    height = int(videoCapture.get(cv2.CAP_PROP_FRAME_HEIGHT))
    outputVideo = cv2.VideoWriter('/home/hayade/project/Tiktok-Filter/outputVideo.mp4', fourcc, videoCapture.get(cv2.CAP_PROP_FPS),
                                  (width, height))
    # The main loop
    while True:
        ...
        if not ret:
            ...
            for idx, filter in enumerate(filters):
                ...
                if filter['morph']:
                    ...
                    tform = fbc.similarityTransform(list(points1.values()), points2[:68])
